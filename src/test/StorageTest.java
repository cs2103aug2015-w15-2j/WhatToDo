...
public class StorageTest {
	...
	@Test
	public void testEditTaskDeadline() throws FileSystemException {
		Storage storage = new Storage();
		storage.overwriteFile("");

		// Setup for testing
		storage.addTask(new Task("arrange meeting", false, new Date("020116")));
		storage.addTask(new Task("send quotation to Nick", false, new Date(
				"020116")));
		storage.addTask(new Task("redraft proposal for abc event", false,
				new Date("030116")));

		// This is a boundary case for 1st item.
		storage.editTaskDeadline(1, new Date("030116"));
		assertEquals(
				"task;send quotation to Nick;todo;020116\ntask;arrange meeting;todo;030116\n"
						+ "task;redraft proposal for abc event;todo;030116\n",
				storage.display());

		// This is a boundary case for last item.
		storage.editTaskDeadline(3, new Date("020116"));
		assertEquals(
				"task;redraft proposal for abc event;todo;020116\ntask;send quotation to Nick;todo;020116\n"
						+ "task;arrange meeting;todo;030116\n",
				storage.display());

		// This is a general case.
		storage.editTaskDeadline(2, new Date("040116"));
		assertEquals(
				"task;redraft proposal for abc event;todo;020116\ntask;arrange meeting;todo;030116\n"
						+ "task;send quotation to Nick;todo;040116\n",
				storage.display());
	...
	@Test(expected = FileSystemException.class)
	public void testEditTaskDeadlineOnFloat() throws FileSystemException {
		Storage storage = new Storage();
		storage.overwriteFile("");
		...
		storage.editTaskDeadline(1, new Date("020116"));
	}

	@Test(expected = FileSystemException.class)
	public void testEditTaskDeadlineOnEvent() throws FileSystemException {
		Storage storage = new Storage();
		storage.overwriteFile("");
	...
	@Test
	public void testEditEventStartDate() throws FileSystemException {
		Storage storage = new Storage();
		storage.overwriteFile("");
		...
		// This is a boundary case for 1st item.
		storage.editEventStartDate(1, new Date("101015"));
		assertEquals("event;class chalet;todo;101015;0800;101015;2359\n"
				+ "event;preparation event;todo;101015;0800;101015;2359\n"
				+ "event;prom night;todo;101015;1700;101015;2359\n",
				storage.display());

		// This is a boundary case for last item.
		storage.editEventStartDate(3, new Date("091015"));
		assertEquals("event;prom night;todo;091015;1700;101015;2359\n"
				+ "event;class chalet;todo;101015;0800;101015;2359\n"
				+ "event;preparation event;todo;101015;0800;101015;2359\n",
				storage.display());
		
		// General Case 
		storage.editEventStartDate(2, new Date("091015"));
		assertEquals("event;class chalet;todo;091015;0800;101015;2359\n" 
				+"event;prom night;todo;091015;1700;101015;2359\n"
				+ "event;preparation event;todo;101015;0800;101015;2359\n",
				storage.display());
	...
	@Test 
	public void testEditEventEndDate() throws FileSystemException {
		Storage storage = new Storage();
		storage.overwriteFile("");

		// Setup for testing.
		storage.addEvent(new Event("prom night", false, new Date("101015"),
				new Date("151015"), "0800", "2359"));
		storage.addEvent(new Event("class chalet", false, new Date("101015"),
				new Date("151015"), "0800", "2359"));
		storage.addEvent(new Event("preparation event", false, new Date(
				"091015"), new Date("101015"), "0800", "2359"));
		...
		// This is a boundary case for 1st item.
		storage.editEventEndDate(1, new Date("111015"));
		assertEquals("event;preparation event;todo;091015;0800;111015;2359\n"
				+ "event;class chalet;todo;101015;0800;151015;2359\n"
				+ "event;prom night;todo;101015;0800;151015;2359\n",
				storage.display());

		// This is a boundary case for last item.
		storage.editEventEndDate(3, new Date("141015"));
		assertEquals("event;preparation event;todo;091015;0800;111015;2359\n"
				+ "event;prom night;todo;101015;0800;141015;2359\n"
				+ "event;class chalet;todo;101015;0800;151015;2359\n",
				storage.display());
	
		// General Case 
		storage.editEventEndDate(2, new Date("171015"));
		assertEquals("event;preparation event;todo;091015;0800;111015;2359\n"
				+ "event;class chalet;todo;101015;0800;151015;2359\n"
				+ "event;prom night;todo;101015;0800;171015;2359\n",
				storage.display());
