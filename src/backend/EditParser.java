...
public class EditParser {
	...
	protected String repeatedKeywords(int nameIndex, int deadlineIndex, int startDateIndex, 
	...
	protected ArrayList<String> getEditList(int nameIndex, int deadlineIndex, int startDateIndex, 
			                              int startTimeIndex, int endDateIndex, int endTimeIndex) {
