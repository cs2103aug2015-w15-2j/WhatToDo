...
public class ConfigHandler {
	...
	public void updateConfigFile(String newLocation) throws FileNotFoundException {
	...
	private void formatAliasContentsAsString(StringBuilder fileContents) throws IOException {
		while (true) {
